...
public class AddListDialogFragment extends DialogFragment {
    ...
    EditText mEditTextZahlFreiTische;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mEditTextZahlFreiTische = (EditText) rootView.findViewById(R.id.edit_text_zahl_freie_tische);
...
*/
    ...
    public void addRestaurant() {
        ...
        String freieTische = mEditTextZahlFreiTische.getText().toString();

//        String freiTische = "44";
        ...
        if (!userEnteredName.equals("")) {
            ...
            Restaurant newRestau = new Restaurant(userEnteredName,freieTische,timestampCreated);

            /* Add the shopping list */
            newListRef.setValue(newRestau);
